...
<?php 
	...
	<h4>Cine</h4>
	<p>Insertar nuevo cine:</p>
	<form action='#' method='post' name='insercion'>
		<label for='campo1'>Nombre:</label>
		<input id='campo1' type='text' name='nombre' value='$insertar[nombre]'>
		<label for='campo2'>Ciudad:</label>
		<input id='campo2' type='text' name='ciudad' value='$insertar[ciudad]'>
		<label for='campo3'>Empresa:</label>
		<input id='campo3' type='text' name='empresa' value='$insertar[empresa]'>
		
		<input type='submit' value='Insertar Datos' name='btInsertar' >
	</form>
	
	<h4>Pelicula</h4>
	<p>Insertar nueva pelicula:</p>
	<form action='#' method='post' name='insercionPelicula'>
		<label for='campo4'>Titulo:</label>
		<input id='campo4' type='text' name='titulo' value='$insertarPelicula[titulo]'>
	...
	<h4>Sala</h4>
	<p>Insertar nueva sala:</p>
	<form action='#' method='post' name='insercionSala'>
		<label for='campo7'>idCine:</label>
		<input id='campo7' type='text' name='idCine' value='$insertarSala[idCine]'>
		<label for='campo8'>Numero:</label>
		<input id='campo8' type='text' name='numero' value='$insertarSala[numero]'>
		<label for='campo9'>Capacidad:</label>
		<input id='campo9' type='text' name='capacidad' value='$insertarSala[capacidad]'>
		
		<input type='submit' value='Insertar Datos' name='btInsertarSala' >
	</form>
	
	<h4>Sesion</h4>
	<p>Insertar nueva sesión:</p>
	<form action='#' method='post' name='insercionSesion'>
		<label for='campo10'>idSala:</label>
		<input id='campo10' type='text' name='idSala' value='$insertarSesion[idSala]'>
		<label for='campo11'>idPelicula:</label>
		<input id='campo11' type='text' name='idPelicula' value='$insertarSesion[idPelicula]'>
		<label for='campo12'>Fecha:</label>
		<input id='campo12' type='date' name='fecha' value='$insertarSesion[fecha]'>
		<label for='campo13'>Hora:</label>
		<input id='campo13' type='text' list='horas' name='hora' value='$insertarSesion[hora]'>
		<datalist id='horas'>
	...
	<form action='#' method='post' name='borrado'>
		<label for='campo14'>Id:</label>
		<input id='campo14' type='text' name='id' value='$borrar[id]'>
	...
	<form action='#' method='post' name='borradoPelicula'>
		<label for='campo15'>Id:</label>
		<input id='campo15' type='text' name='idPelicula' value='$borrarPelicula[id]'>
	...
	<form action='#' method='post' name='borradoSala'>
		<label for='campo16'>Id:</label>
		<input id='campo16' type='text' name='idSala' value='$borrarSala[id]'>
	...
	<form action='#' method='post' name='borradoSesion'>
		<label for='campo17'>IdSala:</label>
		<input id='campo17' type='text' name='idSala' value='$borrarSesion[idSala]'>
		<label for='campo18'>IdPelicula:</label>
		<input id='campo18' type='text' name='idPelicula' value='$borrarSesion[idPelicula]'>
	...
	<form action='#' method='post' name='modificacion'>
		<label for='campo19'>Id:</label>
		<input id='campo19' type='text' name='id' value='$modificar[id]'>
		<label for='campo20'>Nombre:</label>
		<input id='campo20' type='text' name='nombre' value='$modificar[nombre]'>
		<label for='campo21'>Ciudad:</label>
		<input id='campo21' type='text' name='ciudad' value='$modificar[ciudad]'>
		<label for='campo22'>Empresa:</label>
		<input id='campo22' type='text' name='empresa' value='$modificar[empresa]'>
	...
	<form action='#' method='post' name='modificacionPelicula'>
		<label for='campo23'>Id:</label>
		<input id='campo23' type='text' name='idPelicula' value='$modificarPelicula[id]'>
		<label for='campo24'>Titulo:</label>
		<input id='campo24' type='text' name='titulo' value='$modificarPelicula[titulo]'>
		<label for='campo25'>Duracion(min):</label>
		<input id='campo25' type='text' name='duracion' value='$modificarPelicula[duracion]'>
		<label for='campo26'>Genero:</label>
		<input id='campo26' type='text' name='genero' value='$modificarPelicula[genero]'>
	...
	<form action='#' method='post' name='modificacionSala'>
		<label for='campo27'>Id:</label>
		<input id='campo27' type='text' name='idSala' value='$modificarSala[id]'>
		<label for='campo28'>Numero:</label>
		<input id='campo28' type='text' name='numero' value='$modificarSala[numero]'>
		<label for='campo29'>Capacidad:</label>
	    <input id='campo29' type='text' name='capacidad' value='$modificarSala[capacidad]'>
	...
	<form action='#' method='post' name='modificacionSesion'>
		<label for='campo30'>IdSala:</label>
		<input id='campo30' type='text' name='idSala' value='$modificarSesion[idSala]'>
		<label for='campo31'>IdPelicula:</label>
		<input id='campo31' type='text' name='idPelicula' value='$modificarSesion[idPelicula]'>
		<label for='campo32'>Fecha:</label>
		<input id='campo32' type='date' name='fecha' value='$modificarSesion[fecha]'>
		<label for='campo33'>Hora:</label>
		<input id='campo33' type='text' list='horas2' name='hora' value='$modificarSesion[hora]'>
		<datalist id='horas2'>
		  <option>00:00</option><option>00:30</option><option>01:00</option><option>01:30</option><option>02:00</option><option>02:30</option>
		  <option>03:00</option><option>03:30</option><option>04:00</option><option>04:30</option><option>05:00</option><option>05:30</option>
		  <option>06:00</option><option>06:30</option><option>07:00</option><option>07:30</option><option>08:00</option><option>08:30</option>
	...
	<h4>Cine</h4>
	<p>Importar CSV de la tabla cine</p>
	<form action='#' method='post' name='importar' enctype='multipart/form-data'>
		<label for='campo34'>Elige un archivo csv:</label>
		<input id='campo34' type='file' name='file' accept='.csv'>
		<input type='submit' value='Importar' name='btImpCsv' >
		
	</form>
	
	<h4>Pelicula</h4>
	<p>Importar CSV de la tabla pelicula</p>
	<form action='#' method='post' name='importarPelicula' enctype='multipart/form-data'>
		<label for='campo35'>Elige un archivo csv:</label>
		<input id='campo35' type='file' name='filePelicula' accept='.csv'>
		<input type='submit' value='Importar' name='btImpCsvPelicula' >
		
	</form>
	
	<h4>Sala</h4>
	<p>Importar CSV de la tabla sala</p>
	<form action='#' method='post' name='importarSala' enctype='multipart/form-data'>
		<label for='campo36'>Elige un archivo csv:</label>
		<input id='campo36' type='file' name='fileSala' accept='.csv'>
		<input type='submit' value='Importar' name='btImpCsvSala' >
		
	</form>
	
	<h4>Sesion</h4>
	<p>Importar CSV de la tabla sesion</p>
	<form action='#' method='post' name='importarSesion' enctype='multipart/form-data'>
		<label for='campo37'>Elige un archivo csv:</label>
		<input id='campo37' type='file' name='fileSesion' accept='.csv'>
